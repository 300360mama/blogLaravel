...
@section('main')
	<main>
		...
		<div id="comment_article">
				<form action="">
					<input id="comment_article_name" class="comment_input" type="text" placeholder="Ваше имя">
					<input id="comment_article_email" class="comment_input" type="email" placeholder="Укажите ваш email адресс">
					<textarea id="comment_article_text" class="comment_input" type="text" placeholder="Введите комментарий"></textarea>
