...
@section('main')
	<main>
				<div class="post">
					...
					<div class="article">
						<section class="themeSection">
							<span class="category">Travelling</span>
				...
				<div class="post">
					<img src="../images/content/linux_угроза_руки_вверх.jpg" alt="">
					<div class="article">
						<section class="themeSection">
							<span class="category">FASHION & ADVENTURE</span>
							<h3 class="theme">FASHION AND ADVENTURE IN WORLD</h3>
							<section class="authorArticle">
								<section class="authorName">
									<i class="fa fa-user" aria-hidden="true"></i>
									<span>Jhone Albert</span>
								</section>
								<section class="publicationDate">
				...
				<div class="post">
					<img src="../images/content/Windows_7_лягушка_заставка.jpg" alt="">
					<div class="article">
						<section class="themeSection">
							<span class="category">TRAVELLING</span>
							<h3 class="theme">
								Ben Sturgulewski Cinematography Reel :: Sturgefilm 
                               Adventure & travelling 2016
							</h3>
							<section class="authorArticle">
								<section class="authorName">
									<i class="fa fa-user" aria-hidden="true"></i>
				...
				<div class="post">
					<img src="../images/content/семья_Мультфильм_Приключения_Rio.jpg" alt="">
					<div class="article">
						<section class="themeSection">
							<span class="category">LIFESTYLE</span>
							<h3 class="theme">My journey towards a minimalist lifestyle</h3>
							<section class="authorArticle">
								<section class="authorName">
									<i class="fa fa-user" aria-hidden="true"></i>
						...
						<article>
                            ...
                            Today, I continue to simplify our home and gets rids of things that we don’t need. Although we live in a smaller home, the space appears bigger because we own nows less stuff. My goal is no longer to please others by making my home a make have a somthing speacial it a space that my family can enjoy.
						</article>
